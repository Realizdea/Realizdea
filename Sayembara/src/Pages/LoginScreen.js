        ...
        >
          ...
          <View style={{ width: "100%", backgroundColor: "white" }}>
            <Image
              ...
              style={{ resizeMode: "contain", width: "100%", height: 240 }}
            />
          </View>
        </View>
        ...
        >
          ...
          >
            ...
            <View style={styles.itemInput}>
              ...
              {email == "" ? null : (
                <Icons
                  name={checkEmail ? "check-circle" : "close-circle-outline"}
                  color={checkEmail ? "#1DD1A1" : "rgba(0,0,0,0.4)"}
                  size={28}
                />
              )}
            </View>
            ...
            <View style={styles.itemInput}>
              ...
              >
                <Icons
                  ...
                  color={showPassword ? "#1DD1A1" : "rgba(0,0,0,0.4)"}
                  size={28}
                />
              </TouchableWithoutFeedback>
            </View>
          ...
          >
            ...
            >
              <Text style={{ fontWeight: "bold", color: "#62852E" }}>
                Join here
              </Text>
            </TouchableOpacity>
          </View>
