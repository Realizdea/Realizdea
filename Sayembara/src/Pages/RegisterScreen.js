...
export default function RegisterScreen({ navigation}) {
    ...
    const handleRegister = (Fullname, Email, Password, PasswordConfirmation) => {
        if (checkEmail == true && checkPassword == true && fullname !== "" ){
            dispatch(Register(Fullname, Email, Password, PasswordConfirmation))
            ...
            <View style={{ width: "100%", justifyContent: "center", alignItems: "center" }}>
                <View style={{ width: "80%", alignItems: "center", marginBottom: 10 }}>
                    ...
                    <View style={styles.itemInput}>
                        <TextInput placeholder="John" onChangeText={(val) => setFullname(val)} />
                    </View>
                </View>
                ...
                <View style={{ width: "80%", alignItems: "center", marginBottom: 25 }}>
                    ...
                    <View style={styles.itemInput}>
                        <TextInput placeholder="Verify Password..." autoCapitalize="none" secureTextEntry={!showPassword} onChangeText={(val) => setPasswordConfirmation(val)} />
                ...
                <TouchableOpacity style={styles.button} onPress={() => handleRegister(fullname, email, password, passwordConfirmation) }>
                ...
                <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }} >
                    ...
                    <TouchableOpacity onPress={() => navigation.goBack()}>
                        <Text style={{ fontWeight: "bold", color: "#62852E" }}>Sign In here</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
