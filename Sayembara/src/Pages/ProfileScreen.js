...
export default function ProfileScreen({ navigation }) {
  ...
  const handleInitData = () => {
    ...
    setLocation(dataProfile.location);
    setBank(dataProfile.bank);
    setAccount_Number(String(dataProfile.account_number));
    setPhotoProfile(dataProfile.picture);
  };
      ...
      <View style={{ ...styles.container, justifyContent: "center" }}>
        <View style={{ height: 225, justifyContent: "center" }}>
          <Image
            ...
            source={require("../Assets/Images/realizdea_danBunga.png")}
          />
        </View>

        <Text style={{ fontSize: 30, color: "#1DD1A1", fontWeight: "bold" }}>
          Oops!
        </Text>
        <View style={{ flexDirection: "row" }}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("AuthScreen")}>
            <Text
              style={{ fontSize: 20, color: "#1DD1A1", fontWeight: "bold" }}
            >
              Join here
            </Text>
          </TouchableOpacity>
      ...
      {update ? (
        <View style={styles.container}>
          ...
          <View style={styles.itemProfile}>
            ...
            <View
              style={{ width: "80%", alignItems: "center", marginBottom: 25 }}
            >
              ...
              <View style={{ ...styles.itemInput, borderColor: "#1DD1A1" }}>
                <TextInput
                  ...
                  onChangeText={(val) => setAccount_Number(val)}
                />
              </View>
            </View>
            ...
            >
              ...
              <TouchableOpacity
                style={{ ...styles.buttonProfile, width: "40%" }}
                onPress={() =>
                  handleUpdateData(
                    token,
                    userId,
            ...
            >
              ...
              <View style={styles.itemInput}>
                <TextInput
                  ...
                  style={{ color: "black" }}
                  editable={false}
                  value={String(dataProfile.acc_number)}
                />
              </View>
            </View>
