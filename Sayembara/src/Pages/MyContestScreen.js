  ...
  if (token == null) {
    return (
      <View style={{ ...styles.container, justifyContent: "center" }}>
        ...
        <Text style={{ fontSize: 30, color: "#62852E", fontWeight: "bold" }}>
          Oops!
        </Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Contest
                ...
                idContest={item.id}
                handleGoToContestDetail={() => {
                  navigation.navigate("MyContestDetailsScreen", {
                    contestId: item.id,
                  });
...
const Contest = (props) => (
  <View style={styles.contestContainer}>
    <View style={styles.descContainer}>
      ...
      <Text style={{ fontSize: 22, fontWeight: "bold", color: "#10AC84" }}>
        {props.title}
      </Text>
      <View style={{ flexDirection: "row" }}>
        <Text>by </Text>
      ...
      <View style={{ marginTop: 7 }}>
        <Text numberOfLines={3} style={{ color: "rgba(0,0,0,0.3)" }}>
          {props.desc}
        </Text>
      </View>
    </View>
    ...
    <TouchableOpacity
      style={{
        ...styles.buttonApply,
        backgroundColor: "rgba(84, 160, 255, 0.25)",
      }}
      onPress={() => props.handleGoToContestDetail()}
    >
      <Text style={{ color: "#10AC84", fontWeight: "bold", fontSize: 18 }}>
        Open
      </Text>
    </TouchableOpacity>
  </View>
