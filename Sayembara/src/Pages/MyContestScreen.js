        ...
        return (
            <View style={{ ...styles.container, justifyContent: "center" }}>
                <View style={{ height: 225, justifyContent:"center" }}>
                    <Image style={{ width: 350, resizeMode: "contain" }} source={require("../Assets/Images/realizdea_danBunga.png")} />
                </View>

                <Text style={{fontSize:30, color:"#62852E", fontWeight:"bold"}}>Oops!</Text>
